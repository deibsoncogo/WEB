...
import { AccessDeniedError, InvalidCredentialsError, InvalidParamsError } from '../../../domain/errors'
...
export class RemoteUserSignIn implements IUserSignIn {
  constructor(private readonly url: string, private readonly httpClient: HttpClient<IAuthResponse>) {}
  ...
  async signIn(userSignIn: UserSignIn) {
    ...
    switch (httpResponse.statusCode) {
      ...
      case HttpStatusCode.badRequest:
        throw new InvalidCredentialsError("Email ou senha inválida.")
